...
public class StaticPractice {
    public static void main(String[] args) {
        ...
        //ConstructorPractice obj = new ConstructorPractice(); //can't be done unless it's public in ConstructorPractice.java class
            //cannot create an object from it if it's private
        }
    }
